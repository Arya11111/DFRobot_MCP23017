...
void setup() {
  ...
  */
  ...
  //mcp23017.setInterruptPins(0, mcp23017.LowMode);//mcp23017.DA0可用0代替
  
  mcp23017.pinMode(mcp23017.DB0, INPUT);
  //mcp23017.pinMode(8, INPUT);//mcp23017.DB0可用8代替
  ...
  //mcp23017.setInterruptPins(8, mcp23017.LowMode);//mcp23017.DB0可用8代替
  attachInterrupt(0,funA,FALLING);//开启UNO外部中断0
  attachInterrupt(1,funB,FALLING);//开启UNO外部中断1
}
