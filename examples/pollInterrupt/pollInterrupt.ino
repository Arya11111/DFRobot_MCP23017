 ...
 * @n 实验现象：轮询某组端口中断，如果发生中断，则串口打印那个引脚发生中断
 *
...
void setup() {
  ...
  */
  ...
  mcp.pinModeInterrupt(/*p = */mcp.eGPA1, /*mode = */mcp.eFalling, /*cb = */func);//数字引脚1(eGPA1)，下降沿中断，当引脚1的状态从低电平到高电平变化时产生中断，INTA输出高电平
  mcp.pinModeInterrupt(/*p = */mcp.eGPB7, /*mode = */mcp.eRising, /*cb = */func);//数字引脚15(eGPB7)，上升沿中断，当引脚15的状态从高电平到低电平变化时产生中断，INTA输出高电平
